...
# 	# code resolves inner arguements first
# 	my_node = Node("Alec, Node("Sam", Node("Bob")))
# 	"""
...
# 			self.head = new_node
# 			self.tail = new_node
# 		# if linked list contains entries
# 		else:
...
# 		if self.head is None:
# 			return None
# 		# linked list of one item
# 		if self.head.get_next() is None:
# 			head = self.head

# 			# removing head / tail reference to node makes it inaccessable to the linked list and will be cleaned up by memory management
# 			self.head = None
